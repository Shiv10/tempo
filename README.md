...
# Export as individual segments for video editors (outputs to your_video_chunks/)
python3 silence_cut.py your_video.mp4 --split-segments
...
| `--split-segments` | Export each speech segment as an individual video file in a `<input>_chunks/` directory | |
